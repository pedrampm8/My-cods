        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2> <?php echo "find ".count($category['news'])." news "; ?> </h2>
                    <h4> <?php
                        $page = ceil(count($category['news'])/3);
                        echo $page." page news ";
                        ?> </h4>
                    <?php
                    if(isset($_GET['page'])){
                    ...
                    echo "you are in page $numpage";
                        foreach ($category['news'] as $k=>$item){
                            $key = $k +1;
                            $maxnews = $numpage*3;
                            $minnews = $numpage*3-2;
                    ...
                    <div class="text-start py-4">
                        <div class="custom-pagination">
                            <?php
                            if ($numpage != 1){?>
                            <a href="category?id=<?php echo strip_tags($_GET['id']); ?>&page=<?php echo $numpage-1; ?>" class="prev">Prevous</a><?php
                            }
                            For($i=1;$i<=$page;$i++){
                                ?><a href="category?id=<?php echo strip_tags($_GET['id']); ?>&page=<?php echo $i; ?>" <?php if($i == $numpage){echo 'class="active"';} ?>><?php echo $i;?></a><?php
                            }
                            if ($numpage != $page){?>
                                <a href="category?id=<?php echo strip_tags($_GET['id']); ?>&page=<?php echo $numpage+1; ?>" class="next">Next</a>
                                <?php
                            }
                            ?>
                        </div>
