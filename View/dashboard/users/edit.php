...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">ویرایش خبرنگار<a class="btn btn-success" href="/dashboard/users">بازگشت به لیست</a></h6>
        </div>
        <div class="card-body">
            <?php
            ...
            <form class="user" method="POST" action="/dashboard/users/update?id=<?php echo $result['id']; ?>">
                <div class="form-group">
                    <input name="mobile" type="text" class="form-control form-control-user"
                           id="mobile" aria-describedby="emailHelp"
                           placeholder="Enter Mobile ..." value="<?php echo $result['mobile']; ?>">
                </div>
                <div class="form-group">
